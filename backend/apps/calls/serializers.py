...
class ComisionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'campana_nombre', 'monto_venta', 'estado'
        ]
    ...
    def get_monto_venta(self, obj):
        """Obtiene el monto de la venta asociada."""
        if obj.venta and obj.venta.monto:
            return float(obj.venta.monto)
        return 0
    ...
    def get_estado(self, obj):
        """
        Retorna el estado de la comisión.
        Por defecto todas las comisiones generadas están confirmadas.
        """
        return 'CONFIRMADA'